...
const RepresentativeCard = ({data = null}: {data: HandlerInfo}) => {
  ...
  return (
    <StyledContainer
      container={{style: {backgroundColor: colors.icon.background_dark}}}>
      <View style={repItemStyles.wrapper}>
        <View style={repItemStyles.topRow}>
          ...
          <AppText style={repItemStyles.dateText}>
            {utils.safeValue(data?.date)}
          </AppText>
        </View>
